function [pw0 gradient Hpw d3pwdTout3 d4pwdTout4]  = ...
    cracpowerconsumptionfourthorderapproximation(Tin, Tout, ...
    COP, coefficient)
...
d4pwdTout4      = -1*(tempC56+(tempC56+(tempC32*tempC53+(k*(Tin-Tout))*((tempC45+(tempC27*tempC20+tempC14*(tempC40+tempC40)))+tempC45))))+-1*tempC56;
